...
set_target_properties(Allegro::allegro PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.0.sdk/System/Library/Frameworks/AppKit.framework;/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.0.sdk/System/Library/Frameworks/IOKit.framework;/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.0.sdk/System/Library/Frameworks/CoreVideo.framework;/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.0.sdk/System/Library/Frameworks/OpenGL.framework;/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.0.sdk/System/Library/Frameworks/OpenGL.framework"
)
...
set_target_properties(Allegro::allegro_image PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "Allegro::allegro;/opt/homebrew/Cellar/webp/1.3.2/lib/libwebp.dylib;/opt/homebrew/Cellar/webp/1.3.2/lib/libsharpyuv.dylib"
)
...
set_target_properties(Allegro::allegro_audio PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "Allegro::allegro;/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.0.sdk/System/Library/Frameworks/AudioToolbox.framework;/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.0.sdk/System/Library/Frameworks/OpenAL.framework"
)
...
set_target_properties(Allegro::allegro_acodec PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "Allegro::allegro_audio;/opt/homebrew/lib/libFLAC.dylib;/opt/homebrew/lib/libogg.dylib;/opt/homebrew/lib/libdumb.dylib;m;/opt/homebrew/lib/libvorbisfile.dylib;/opt/homebrew/lib/libvorbis.dylib;/opt/homebrew/lib/libogg.dylib;/opt/homebrew/lib/libopusfile.dylib;/opt/homebrew/lib/libopus.dylib;/opt/homebrew/lib/libogg.dylib"
)
...
set_target_properties(Allegro::allegro_ttf PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "Allegro::allegro_font;/opt/homebrew/lib/libfreetype.dylib"
)
...
set_target_properties(Allegro::allegro_physfs PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "Allegro::allegro;/opt/homebrew/lib/libphysfs.dylib"
)
...
set_target_properties(Allegro::allegro_video PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "Allegro::allegro;Allegro::allegro_audio;/opt/homebrew/lib/libtheoradec.dylib;/opt/homebrew/lib/libogg.dylib;/opt/homebrew/lib/libvorbisfile.dylib;/opt/homebrew/lib/libvorbis.dylib;/opt/homebrew/lib/libogg.dylib"
)
